...
*   **Buffering**: We do NOT write to Kafka on every request.
    ...
    *   *Trade-off*: If Collector hits OOM, we lose 100ms of data (Acceptable for Analytics).

## Kafka Partitioning Strategy
*   **Topic**: `events_v1`.
*   **Partitions**: 64.
*   **Key**: `user_id`.
    *   *Why?* Ensures all events for a single user land on the same partition. This guarantees strict ordering for "Sessionization" logic (e.g., did they click 'Signup' *after* 'Pricing'?).
