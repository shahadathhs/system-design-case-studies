...
- **Decision**: **JSON** (at the edge).
  - _Reason_: Easier for frontend devs to debug. We convert to Binary (Parquet/ClickHouse format) deeper in the pipeline. We trade a bit of CPU at the ingestion layer for Developer Experience.
