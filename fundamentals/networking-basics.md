...
*   **Public IP**: The external address. Unique across the entire internet.
    *   *Analogy*: Your home mailing address.
*   **Private IP**: Internal address. Only works inside a specific network (like AWS VPC).
    *   *Analogy*: "Room 203". Meaningless unless you are already inside the building.
    *   *Crucial for Backends*: Your Database should **ALWAYS** have a Private IP. If it has a Public IP, it is being scanned by hackers right now.
...
*   **Usage**: Websites, APIs, Databases, File Downloads. *Basically everything you build.*
...
*   **Handshake**:
    ...
    4.  *All future data is encrypted.*
