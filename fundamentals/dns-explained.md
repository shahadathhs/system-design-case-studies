...
*   *Usage*: Pointing your domain to a Load Balancer or EC2 instance.
...
*   *Usage*: Aliasing. Very common with AWS Load Balancers (ALB) because AWS IPs change, but their DNS names don't.
*   *Restriction*: You usually cannot put a CNAME at the "Root" (`myapp.com`). Only subdomains.
...
*   *Problem*: If `1.1.1.1` goes down, DNS keeps sending people there. It has no "Health Check".
