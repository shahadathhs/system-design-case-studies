...
_How to Lead the Room, Structure Your Answers, and Get the Job_
...
2.  **Communication**: Can you explain _why_ you chose Postgres over Mongo?
...
**Beginner Mistake**: Drawing 50 microservices immediately. Start with a Monolith/Simple Service, then split it _only when you find a bottleneck_.
...
- **Default to SQL (Postgres)**.
  - _Reason_: "Most data is relational (data links to users). We need ACID guarantees for payments/profiles."
...
1.  **The "Shower" Method**: Pick an app (Instagram). Explain _out loud_ how you'd build the feed while in the shower.
...
_Good luck. You know the code; now you just need to explain the plan._
