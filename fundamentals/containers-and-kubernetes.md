...
- _Note_: Pods are mortal. If they die, K8s creates a new one. Never rely on a Pod IP staying the same.
...
- Traffic to the _Service_ is load-balanced to the healthy _Pods_.
